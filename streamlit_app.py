...
st.set_page_config(page_icon="👨‍💼", layout="wide",
                   page_title="Zaw's Resume Bot")


st.subheader("👨‍💼📊📈📁 Zaw's Interactive Resume")
st.write(
    "Welcome to Zaw's personal chat bot to answer Zaw's previous experiences and his skillsets. Ask away what you want to know!"
)
